...
public class FrmTiendaVideojuegosNormal extends JFrame {
    ...
    public FrmTiendaVideojuegosNormal() throws HeadlessException, FileNotFoundException {
    ...
    private ArrayList<Videojuego> leerDatosVideojuegos() throws FileNotFoundException {
        ...
        String[] datos;
        File archivo = new File(getClass().getResource("ventas_videojuegos.txt").getFile());
    ...
    public static void main(String[] args) throws FileNotFoundException {
        new FrmTiendaVideojuegosNormal().setVisible(true);
    }
}
